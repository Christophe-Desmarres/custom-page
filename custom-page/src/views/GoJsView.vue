<template>
    <div>
        ...
        <div id="myPaletteDiv" style="border: solid 1px black; width:100%; height:100px"></div>
        <button id="mySavedModel" style="border: solid 1px black; width:100%; height:100%; background: lightgray">save</button>
    </div>
</template>
...
myDiagram.model = new go.GraphLinksModel(
  ...
  new go.Node("Auto")  // the Shape will automatically surround the TextBlock
    ...
    .add(new go.Shape("RoundedRectangle",{ strokeWidth: 0, fill: "white" })  // no border; default fill is white
    ...
    .add(new go.TextBlock({ margin: 8, stroke: "#333" })  // some room around the text
      ...
      // permettre le redimensionnement des cases
      myDiagram.nodeTemplate =
        $(go.Node, "Spot",
        ...
        // fonction pour ajouter des liens entre les cases
      ...
      // ajoute des courbes aux fleches des liens
